...
import model.zaf.keys as I

__author__ = 'Chu-Chang Ku'
__all__ = ['ModelZAF']


class ModelZAF(AbsModel):
    def update_parameters(self, pars):
        ...
        to = self.Inputs.TxOut['PLHIV']
        pars['r_tl_plhiv'] = r_ts * to.PrTxLTFU / to.PrTxSucc
        pars['r_death_tx_plhiv'] = r_ts * to.PrTxDie / to.PrTxSucc

        to = self.Inputs.TxOut['NonHIV']
        pars['r_tl_nhiv'] = r_ts * to.PrTxLTFU / to.PrTxSucc
        pars['r_death_tx_nhiv'] = r_ts * to.PrTxDie / to.PrTxSucc
    ...
    def calc_demography(self, t, y, pars, dy, da, calc):
        ...
        dr_tb[I.Tx, :1] = pars['r_death_tx_nhiv']
        dr_tb[I.Tx, 1:] = pars['r_death_tx_plhiv']
    ...
    def calc_cascade(self, t, y, pars, dy, da, calc):
        ...
        trs_hiv = [list(trs0) for _ in range(3)]

        trs_hiv[0].append((I.Tx, I.RHigh, pars['r_tl_nhiv'], 'txl'))

        trs_hiv[1] += [
            (I.Tx, I.RHigh, pars['r_tl_plhiv'], 'txl'),
